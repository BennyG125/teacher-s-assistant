...
def vurder_novelle(novelle_tekst):
    ...
    if kategori.lower() == 'novelle':
        ...
        full_prompt += f"\nHer er novellen:\n\n{novelle_tekst}\n\nVennligst gi en detaljert vurdering av novellen basert på disse punktene. Avslutt med en helhetlig karakter for oppgaven (f.eks. A, B, C, D, E eller F). Uthev karakteren \
        i fet skrift"
